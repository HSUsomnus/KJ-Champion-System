...
> **版本 v2.0.5** | 分支：`main` | 部署：[kj-champion-system.pages.dev](https://kj-champion-system.pages.dev) | 更新：2026-04-25
...
| 首次登入流程 | LINE OAuth 登入後若 member 不存在引導至 `/profile/edit` 完成資料建立（v2.0.5） | 所有人 |
