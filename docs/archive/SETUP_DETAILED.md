...
# 選填：邀請字卡「添加小幫手為好友」按鈕連結；未設則按鈕會開 LIFF 網址
# LINE_ADD_FRIEND_URL=https://line.me/R/ti/p/@你的官方帳號ID
...
1. **設定 Google Cloud 專案**（參考 docs/SETUP.md 第 3 節）
2. **設定 LINE LIFF**（參考 docs/SETUP.md 第 4 節）
3. **填入真實的環境變數值**
