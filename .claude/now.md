...
v2.8.0 — change 17「SidebarNav UI 重構」。SidebarNav 加品牌文字 + 管理者後台入口；Management 標題 + pill tab 重構；update-roles 開放負責人；admin.js 新增 export-backup-csv、移除 sync-backup-to-dev（安全）；scripts/import-csv-to-dev.js 手動 CSV→dev DB 工具。
