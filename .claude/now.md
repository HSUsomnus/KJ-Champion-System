...
本 commit 為規則整批同步：workflow.md 大改（新功能/修改/執行/測試/上線流程強化）、frontend.md 重寫（舊 public/ 改為 frontend/ React+Vite）、CLAUDE.md 精簡（雙裝置/決策規範移入 workflow.md）、STATUS.md 職責收窄（只留路線圖）。
