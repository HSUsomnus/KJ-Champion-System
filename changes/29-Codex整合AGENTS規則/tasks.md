...
- [x] 0.2 讀 `spec.md`（範圍 A/A/A 已定案；上傳來源 = CLAUDE3.md 第六節第 1 點）
...
- [x] 2.1 `.claude/skills/deploy-release/SKILL.md` 允許清單（約 129–132 行）在 `CLAUDE.md`/`CHANGELOG.md` 旁補 `AGENTS.md`（一行）
- [x] 2.2 Gate：`grep -n "AGENTS.md" .claude/skills/deploy-release/SKILL.md` 命中允許清單段
- [x] 2.3 確認未動「不得直推」清單、未動直推流程步驟

## Phase 3 — now.md 更新（與上線同 commit）

- [x] 3.1 `.claude/now.md`「最近推送」新增 change 29 紀錄（AGENTS.md 建立 + deploy-release 允許清單補 AGENTS.md）
- [x] 3.2 Gate：`grep -c "change 29" .claude/now.md` ≥ 1
